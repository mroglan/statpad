...
export default verifyUser(async function DeleteTest(req:NextApiRequest, res:NextApiResponse) {
    ...
    try {
        ...
        await db.collection('tests').deleteOne({_id: new ObjectId(req.body.testId)})
