...
export default function OneSampleHT({component, syncData, sync, index, data}:TestI) {
    ...
    const [testProperties, setTestProperties] = useState(fakeProperties) // change to component.properties
        ...
        <Box pl={6} pt={3}>
            <Grid container spacing={3} alignItems="center">
                ...
                {testProperties.type === 'proportion' ? <>
                    ...
                    <Grid item>
                        <TextField label="Sample Prop." value={testProperties.inputs.sampleSize} className={classes.numInput}
                        variant="outlined" InputProps={{className: classes.textWhite}}
                        InputLabelProps={{className: classes.dimWhite}}
                        onChange={(e) => setTestProperties({...testProperties, inputs: {
                            ...testProperties.inputs,
                ...
                <Grid item style={{display: 'flex', alignItems: 'center'}}>
                    <Grid item style={{padding: '0 .5rem'}}>
                        <Typography variant="h6" className={classes.textWhite}>
                            {testProperties.type === 'proportion' ? testProperties.inputs.proportion : testProperties.inputs.mean}
                        </Typography>
                    </Grid>
                    <Grid item style={{padding: '0 .5rem'}}>
