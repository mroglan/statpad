...
export default function scatterOptionsDialog({property, index, handlePropertyChange, handleOptionsClose, optionsSwitch}: OptionsInterface) {

    const updateChart = () => {
        const propertyCopy = {...property}
        propertyCopy.options.points.color = pointColorRef.current.value || 'none'
        propertyCopy.options.points.radius = pointRadiusRef.current.value
