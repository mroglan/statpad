...
export default function lineOptionsDialog({property, index, handlePropertyChange, handleOptionsClose, optionsSwitch}: OptionsInterface) {
    ...
    const updateChart = () => {
        ...
        propertyCopy.options.points = {
            color: pointColorRef.current.value,
            radius: pointRadiusRef.current.value
        }
    ...
    return (
        <Dialog fullWidth open={optionsSwitch[index]} onClose={handleOptionsClose} aria-labelledby="line plot options"
            ...
            <DialogContent>
                ...
                <Grid container direction="row" className={classes.morePadding}>
                    ...
                    <Grid item sm={4} container alignItems="center">
                        ...
                        <TextField type="text" defaultValue={property.options.points.radius} inputRef={pointRadiusRef}
                        className={classes.numberInput} InputProps={{disableUnderline: true}} />
                    </Grid>
                </Grid>
                <Grid container direction="row" className={classes.morePadding}>
